...
public partial class DeTreManContract : DeTreManContractImplContainer.DeTreManContractImplBase
{
    public override Empty CreateScheme(CreateDeTreManProfitSchemeInput input)
    {
        ...
        State.DeTreManProfitSchemes[Context.Sender] = new DeTreManProfitScheme
        {
            Symbol = input.Symbol,
    ...
    public override Empty AddBeneficiary(AddDeTreManBeneficiaryInput input)
    {
    ...
    public override Empty RemoveBeneficiary(RemoveDeTreManBeneficiaryInput input)
    {
        var scheme = GetValidScheme(Context.Sender);
    ...
    public override Empty DistributeProfits(DistributeProfitsInput input)
    {
        ...
        State.DeTreManProfitSchemes[input.SchemeManager] = scheme;
        return new Empty();
    }
    ...
    public override DeTreManProfitScheme GetScheme(Address input)
    {
        return State.DeTreManProfitSchemes[input];
    }

    public override ReceivedProfitsMap GetProfitsMap(ClaimProfitsInput input)
    {
        var scheme = State.DeTreManProfitSchemes[input.SchemeManager];
    ...
    private DeTreManProfitScheme GetValidScheme(Address manager, bool updateSchemePeriod = false)
    {
        var scheme = State.DeTreManProfitSchemes[manager];
        Assert(scheme != null, "Token holder profit scheme not found.");
        UpdateDeTreManProfitScheme(ref scheme, manager, updateSchemePeriod);
        return scheme;
    }

    private void UpdateDeTreManProfitScheme(ref DeTreManProfitScheme scheme, Address manager,
        bool updateSchemePeriod)
    {
        ...
        State.DeTreManProfitSchemes[Context.Sender] = scheme;
    }
}